...
class withinweb_wwkc_keycodes_Loader {

	//Array of actions registered with WordPress to fire when the plugin loads.
    protected $actions;
	//Array of filters registered with WordPress to fire when the plugin loads.
    protected $filters;

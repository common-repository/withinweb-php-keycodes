<?php
class withinweb_wwkc_keycodes_html_output {
                ...
                switch ($value['type']) {
                    ...
                    case 'single_select_page' :
                        ...
                        ?><tr valign="top" class="single_select_page">
                            ...
                            <td class="forminp">
                                <?php echo str_replace(' id=', " data-placeholder='" . __('Select a page&hellip;', 'withinweb-wwkc-keycodes') . "' style='" . $value['css'] . "' class='" . $value['class'] . "' id=", wp_dropdown_pages($args)); ?> <?php echo $description; ?>
                            </td>
                        </tr><?php
                        break;
...
withinweb_wwkc_keycodes_html_output::init();
